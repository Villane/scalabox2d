...
object PolygonCollider {
  ...
  def collidePolygons(polyA: Polygon, xfA: Transform2f,
    ...
    val v11x = xf1.pos.x + xf1.rot.col1.x * v11.x + xf1.rot.col2.x * v11.y
    val v11y = xf1.pos.y + xf1.rot.col1.y * v11.x + xf1.rot.col2.y * v11.y
    val v12x = xf1.pos.x + xf1.rot.col1.x * v12.x + xf1.rot.col2.x * v12.y 
    val v12y = xf1.pos.y + xf1.rot.col1.y * v12.x + xf1.rot.col2.y * v12.y
